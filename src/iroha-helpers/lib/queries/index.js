...
function getPendingTransactions(queryOptions, _a) {
    var pageSize = _a.pageSize, firstTxHash = _a.firstTxHash;
...
function getAccountTransactions(queryOptions, _a) {
    var accountId = _a.accountId, pageSize = _a.pageSize, _b = _a.firstTxHash, firstTxHash = _b === void 0 ? undefined : _b;
...
function getAccountAssetTransactions(queryOptions, _a) {
    var accountId = _a.accountId, assetId = _a.assetId, pageSize = _a.pageSize, firstTxHash = _a.firstTxHash;
